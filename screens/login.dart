...
Future<void> _submit() async {
  if (_formKey.currentState!.validate()) {
    ...
    const String requestId = "20231103121111";
    final String userName = taxCodeController.text;
    final String passWord = passwordController.text;
    const String otpNo = "";
    const String version = "1.0";
    const String operatingSystem = "android";
    const String token = "";
    const String deviceId = "Android SDK built for x86";
    const String code = "";
    const String tokenPush = "cznYpkvbTHO-jK-yN-72-c:APA91bE_Mz_R-GJ424T7_sIAgcYD1YMRrfu4HUj3AqPdMQHVUE3yhr-7fmhRq3UdlUDb-ky56HiEtzSBtmDU-LRlElaz6HQeiuILbiwspF1E81pbu1ykrvBXtO1ofczx7OuNbu34tYjx";
    const String sodinhdanh = "";

    final resultToken = await loginModel.login(
      userName,
      passWord,
      requestId,
      otpNo,
